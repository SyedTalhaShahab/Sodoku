...
//         val button = Button("Check Solution")
//         button.setOnAction {
//             if (isValidSolution()) {
...
//         // Set column and row constraints to ensure each cell is the same size
//         for (i in 0 until size) {
//             val column = ColumnConstraints(cellSize)
//             grid.columnConstraints.add(column)
//             val row = RowConstraints(cellSize)
...
//                 cell.style = "-fx-alignment: center; -fx-font-size: 18px;"
//                 grid.add(cell, j, i)
//             }
//         }
...
//         // Add button at the bottom of the grid
//         val buttonRow = RowConstraints(cellSize)
//         grid.rowConstraints.add(buttonRow)
//         grid.add(button, size / 2, size)
